...
import 'package:my_tools_application/page/multiple_text_edit_page.dart' deferred as deferred_multiple_text_edit_page;
import 'package:my_tools_application/page/back_login_param_page.dart' deferred as deferred_back_login_param_page;
...
class RouteConfig{
  ...
  static const String multipleTextEditPage = "/multipleTextEditPage";
  static const String backLoginParamPage = "/backLoginParamPage";
  ...
  static final List<GetPage> getPages = [
    ...
    GetPage(name: multipleTextEditPage, page: () => DeferredRouter(future: deferred_multiple_text_edit_page.loadLibrary(), builder: (_) => deferred_multiple_text_edit_page.MultipleTextEditPage())),
    GetPage(name: backLoginParamPage, page: () => DeferredRouter(future: deferred_back_login_param_page.loadLibrary(), builder: (_) => deferred_back_login_param_page.BackLoginParamPage())),
